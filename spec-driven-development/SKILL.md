...
If the user doesn't know what to do or didn't include enough context for you to know what we are doing in this session, please output the verbatim the `Default Orientation Behavior` above.
